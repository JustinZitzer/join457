function getContactOverlay(contact) {
    ...
    <div id="contacts_side_overlay" class="contacts-overlay-container">
                ...
                <svg onclick="openContactsSideCardOverlay(${contact.id})" id="close-side-contact-arrow-icon" class="close-side-contact-arrow-icon" width="32" height="32" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
