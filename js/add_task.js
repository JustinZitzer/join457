...
function overlayToDo() {
    ...
    // Inhalt leeren, um Mehrfach-Hinzufügen zu verhindern
    overlayContentToDo.innerHTML = '';

    overlayContentToDo.innerHTML += `
        <div class="overlay-todo-contentTodo" onclick="event.stopPropagation()">
            <div class="container-both-sides">
                <div class="inputfield-box-left-side">
                    <div class="text-title">
                        <div class="text-title-mark">
                    ...
                    <div class="description-main-box">
                        ...
                        <div class="inputfield-due-date-container">
                            ...
                            <input type="text" placeholder="dd/mm/yyyy" class="due-date-text-field">
                        </div>
                    </div>
                </div>
                <img class="line-middle-of-both-container" src="./assets/icons/Vector 4.png" alt="line between bothcontainers">
                <div class="inputfield-box-right-side">
                    <div class="text-priority">
                        <div class="priority-box">
                            <span>Priority</span>
                        ...
                        <div class="assigned-inputfield-box">
                            <span>Assigned to</span>
                            <input type="text" placeholder="Select contacts to assign" class="inputfield-text-assign">
                            <img class="assigned-arrow-icon" src="./assets/icons/arrow_drop_down.png" alt="assigned-arrow-button">
                        </div>
                        <div class="task-inputfield-box">
                            <div class="category-mark">
                                <span>Category</span>
                            ...
                            <input type="text" placeholder="Select task category" class="inputfield-category-assign">
                            <img class="assigned-arrow-icon-down" src="./assets/icons/arrow_drop_down.png" alt="assigned-arrow-button">
                        </div>
                        <div class="subtask-inputfield-box">
                            <span>Subtasks</span>
                            <div class="subtask-inputfield-container">
                                <img class="add-icon-container" src="./assets/icons/subtask-plus-icon.svg" alt="subtask-plus-icon">
                                <input type="text" placeholder="Add new subtask" class="inputfield-subtask-assign">
                            </div>
                        </div>
                    </div>
...
function openOverlayInProgress() {
    ...
    let overlayProgress = document.getElementById('content-add-task-overlay-in-progress');
    overlayProgress.innerHTML += `
    <div class="container-both-sides">
            <div class="inputfield-box-left-side">
                <div class="text-title">
                    <div class="text-title-mark">
