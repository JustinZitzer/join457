...
function editTask(task, taskKey) {
  const editBigTaskDiv = document.getElementById(`big-task-${taskKey}`);
  editBigTaskDiv.innerHTML += `
    <div id="big-task-edit${taskKey}" class="big-task-panel  display-none">
      ...
      <div class="due-date-edit-div">
        ...
        <div class="img-input-date-edit-div">
          ...
          <img class="calendar-icon-edit-task-big" src="./assets/icons/calendar-icon.svg" alt="">
        <div>
      </div>
      ...
      <div id="three-circle-todo-edit${taskKey}" class="three-circle-todo-edit display-none">
